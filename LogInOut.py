...
Password1 = placeholder.text_input('Enter a password',type='password')
btnLogIn = st.sidebar.checkbox("Log in")
btnLogOut = st.sidebar.button('Log Out', key=1)
if btnLogOut:
    Password1 = placeholder.text_input('Enter a password', value='', key=1)
